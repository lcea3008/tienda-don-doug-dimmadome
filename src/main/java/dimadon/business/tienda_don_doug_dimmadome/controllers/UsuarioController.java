...
public class UsuarioController {
    ...
    // response.put("tipoUsuarioId", usuario.getTipoUsuario().getIdTipoUsuario());
    // // Solo el ID del
    // // tipoUsuario
    ...
    // } catch (Exception e) {
    // response.put("success", false);
    // response.put("message", "Error en el servidor. Por favor intenta más
    // tarde.");
    // return
    ...
    // @PutMapping("/{id}")
    // public ResponseEntity<Usuario> actualizarUsuario(@PathVariable("id") int id,
    ...
    // public ResponseEntity<List<Usuario>> obtenerUsuariosPorEstado(@PathVariable
    // String estado) {
